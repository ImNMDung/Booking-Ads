    ...
    public class AccountRepository : IAccountRepository
    {
     ...
     VALUES
           (@UserName,@Password,@FirstName,@LastName,@Gender,null,null,null,@Phone)";
                ...
                var commandCreateEmployee = new CommandDefinition(sqlCreateEmployee, parameters: parameters, flags: CommandFlags.NoCache);
                var employee = conn.Execute(commandCreateEmployee);
                        trans.Commit();
                        return employee == 1;
                    }
                    catch (SqlException)
